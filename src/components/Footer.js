        ...
        <div className="col-12">
          <div className="footer">
            ...
            <ul className="footer-menu">
              <li>
                <a rel="noopener noreferrer" aria-label="Twitter Luu Binh An" target="_blank" href="https://twitter.com/luubinhan">
              ...
              <li>
                <a rel="noopener noreferrer" aria-label="LinkedIn Luu Binh An" target="_blank" href="https://www.linkedin.com/in/luubinhan1989/">
              ...
              <li>
                <a rel="noopener noreferrer" aria-label="Codepen.io Luu Binh An" target="_blank" href="https://codepen.io/luckyluu/">
